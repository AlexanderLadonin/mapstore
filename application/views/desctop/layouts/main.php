...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/<?php echo(MY_DIR_DESCTOP_NAME); ?>/generic.css"/>
        <link rel="stylesheet" type="text/css" href="/css/<?php echo(MY_DIR_GENERIC_NAME); ?>/catalog.css"/>
        <link rel="stylesheet" type="text/css" href="/css/<?php echo(MY_DIR_DESCTOP_NAME); ?>/catalog.css"/>
        <link rel="stylesheet" type="text/css" href="/css/<?php echo(MY_DIR_GENERIC_NAME); ?>/main.css"/>
        <link rel="stylesheet" type="text/css" href="/css/<?php echo(MY_DIR_DESCTOP_NAME); ?>/main.css"/>
